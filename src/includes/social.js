...
const Social = () => (
  <ul className="social-links">
    <li>
      <a
        href="https://soundcloud.com/bazeblackwood"
        className="box sc"
        title="SoundCloud"
      >
        ...
        {/*<!--[if lt IE 9]><em>SoundCloud</em><![endif]-->*/}
      </a>
    </li>
    <li>
      <a
        href="https://www.youtube.com/channel/UCEZ0udCbrp6TbJ0sWbrGEjw"
    ...
    <li>
      <a
        href="https://github.com/blackwood"
    ...
    <li>
      <a
        href="https://instagram.com/bazeblackwood"
